...
def load_coco_pairs(path, n):
    ...
    return pairs  # [(file_name, caption), ...]

# Real 이미지 준비 (pair 순서에 맞게 00000.png ~ 00999.png 로 저장)
...
real_fnames = [f"{i:05d}.png" for i in range(len(pairs))]  # 00000.png ~ 00999.png
prompt_pool = [caption for _, caption in pairs]             # 대응 캡션
