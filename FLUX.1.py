...
SEED = 42
REFERENCE_STEP = 100
GUIDANCE_SCALE = 3.5   # FLUX.1-dev 공식 기본값
...
# Model Loading (FLUX.1-dev: bfloat16 권장)
...
with torch.inference_mode():
    _ = pipe(prompt_pool[:2], num_inference_steps=20, guidance_scale=GUIDANCE_SCALE, height=H, width=W)
    ...
    try:
        ...
        with torch.inference_mode():
            for i in range(0, TOTAL_IMAGES_QUALITY, BATCH_SIZE_QUALITY):
                ...
                # CLIP Score (cosine similarity, transformers 5.x 호환)
