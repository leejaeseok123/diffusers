...
csv_output_file      = "/home/jslee/diffusion_exper/batch_exper/fid/results/SD3.5-medium_pick_image.csv"
...
# SD3.5-medium 모델 로드
# -----------------------
print("[*] Loading SD3.5-medium (stabilityai/stable-diffusion-3.5-medium)...")
