...
csv_output_file      = "/home/jslee/diffusion_exper/batch_exper/fid/results/SD3.5-turbo_pick_image.csv"
...
# SD3.5-turbo 모델 로드
# -----------------------
print("[*] Loading SD3.5-turbo (stabilityai/stable-diffusion-3.5-large-turbo)...")
