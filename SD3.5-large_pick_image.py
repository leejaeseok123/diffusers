...
csv_output_file      = "/home/jslee/diffusion_exper/batch_exper/fid/results/SD3.5-large_pick_image.csv"
...
# SD3.5-large 모델 로드
# -----------------------
print("[*] Loading SD3.5-large (stabilityai/stable-diffusion-3.5-large)...")
